...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/168.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo $url_path ?>/js/168.js"></script>
 
   
</head>

<body>
    <?php include $dir_block.'/168-content.php'; ?>
