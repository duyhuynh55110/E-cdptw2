...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/166.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo $url_path ?>/js/166.js"></script>
 
   
</head>

<body>
    <?php include $dir_block.'/166-content.php'; ?>
